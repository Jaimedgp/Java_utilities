...
/**
 * Clase principal que muestra por pantalla la precipitacion del 22/09/2014, de los mes de enero y de marzo del 2016
...
public class Santander {
	...
	public static void main(String[] args) {
		...
		DatosPluviometro santander = new DatosPluviometro("datos.txt"); // Se crea el objeto con los datos del archivo "datos.txt"
		...
		DatosPluviometro cadiz = new DatosPluviometro("desierto.txt"); // Se crea el objeto con los datos del archivo "desierto.txt" (inexistente)
